    ...
    <div>
        ...
        <form class="row g-3 needs-validation" action="{{route('items.save')}}" method="POST" novalidate>
            ...
            <div class="col-md-6">
                ...
                <input type="number" min="1000" class="form-control" id="harga" name="harga" required>
                <div class="invalid-feedback">
            ...
            <div class="col-md-3">
                ...
                <input type="number" max="100" min="0" class="form-control" id="diskon" name="diskon" required>
                <div class="invalid-feedback">
                    Masukan diskon!!!
                </div>
            </div>
